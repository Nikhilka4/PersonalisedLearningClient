...
const Profile: FC<Props> = ({ user }) => {
  ...
  return (
    <div className="w-[85%] h-screen flex mx-auto">
      <div
        className={`w-[60px] 800px:w-[310px] h-[450px] dark:bg-slate-900 bg-gray-300 bg-opacity-90 dark:border-[#ffffff1d] border-[#fff] rounded-[5px] shadow-xl dark:shadow-xl mt-[80px] mb-[80px] sticky ${
